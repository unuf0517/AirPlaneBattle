...
public class LowEnemyPlane extends Plane{
    ...
    private static final String[] C_PATH={
            ...
            "/images/game/color/plane/enemy1_2.png"
    };
    ...
    public LowEnemyPlane(int x, int y){
        super(x,y,1);
        loadImage();
        this.setMaxHp(GameController.lowEnemyMaxHp);
    }
